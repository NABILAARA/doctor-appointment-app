  ...
  return (
    <div className="form-container">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="btn-primary" style={{ width: "100%" }} disabled={loading}>{loading ? "Logging in..." : "Login"}</button>
        <p style={{ textAlign: "center", marginTop: "15px" }}>No account? <Link to="/register">Register</Link></p>
      </form>
    </div>
  );
};
